...
alias vi='vim' 
alias flux-night='killall xflux; xflux -l 45 -g 4 -k' 
alias flux-day='killall xflux; xflux -l -43 -g 172 -k'
...
#Aliases temporaires pour dev
alias launch-vue-project='cd /srv/webpack/el-bubar && npm run dev'
alias launch-node-rest-server='cd /srv/node/restful && npm start'
